...
Run `migrations/20260804_add_feature_lab_screenshots.sql` to generate preview URLs for existing Feature-Lab items. New items receive a browser-rendered preview automatically.
