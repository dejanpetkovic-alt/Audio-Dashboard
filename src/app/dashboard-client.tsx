...
export default function Dashboard({ initialCases, sourceNames, connected, loadError }: { initialCases: Case[]; sourceNames: string[]; connected: boolean; loadError: boolean }) {
